                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            <label class="toggle-switch toggle-switch-info">
                                                                <input onchange="leaveStatusEnable(<?php echo $i; ?>)" id="checkBox<?php echo $i; ?>" value="<?php echo $rowemployee['id']; ?>"
                                                                    type="checkbox" checked>
                                                                <span class="toggle-slider round"></span>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <select class="form-control text-dark" disabled name="" id="status<?php echo $i; ?>">
                                                                <?php
                                                                $queryemployeeleave = "SELECT * FROM leave_status";
                                                                $resultemployeeleave = $db->query($queryemployeeleave);

                                                                if ($resultemployeeleave) {
                                                                    while ($rowemployeeleave = $resultemployeeleave->fetch_assoc()) {
                                                                ?>
                                                                        <option value="<?php ?>"><?php echo $rowemployeeleave['status']; ?></option>
                                                                <?php
                                                                    }
                                                                }
                                                                ?>
